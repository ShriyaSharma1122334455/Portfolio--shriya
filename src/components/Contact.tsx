...
import { Mail, Copy, Check, Send, ArrowUpRight, Github, Linkedin, MessageSquare } from 'lucide-react';
...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 px-6 sm:px-10 md:px-16 lg:px-24">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-2 mb-12">
          ...
          <p className="text-sm text-zinc-400 max-w-lg">
            Have an open software or cloud engineering role, or a project in mind? Reach out directly.
          </p>
        </div>
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div className="glass-card rounded-2xl p-5">
              <div className="text-xs text-zinc-300 flex items-center gap-2">
                ...
                <span className="font-semibold text-white">Current Availability</span>
              </div>
              <p className="text-xs text-zinc-400 mt-2 leading-relaxed">
                Open for full-time Software Engineer, Cloud Architect, and Frontend roles.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-7 glass-card rounded-2xl p-6 sm:p-8">
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full rounded-xl bg-white hover:bg-zinc-200 text-zinc-950 py-2.5 px-4 text-xs font-semibold flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-sm"
                >
